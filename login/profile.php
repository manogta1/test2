...
<body>
                ...
                <?php if (count($messages) > 0): ?>
                    <ul>
                        <?php foreach ($messages as $msg): ?>
                            <li>
                                <strong><?php echo htmlspecialchars($msg['username']) . ' ' . htmlspecialchars($msg['last_name']); ?></strong>: <?php echo htmlspecialchars($msg['message']); ?>
    ...
    <footer>
        <p>&copy; 2023 <?php echo htmlspecialchars($username); ?></p>
    </footer>
</body>
</html>